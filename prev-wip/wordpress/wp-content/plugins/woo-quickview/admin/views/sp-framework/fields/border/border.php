	...
	class SP_WQV_Framework_Field_border extends SP_WQV_Framework_Fields {
		...
		public function render() {
			...
			if ( ! empty( $args['all'] ) ) {
				...
				echo '<input type="number" name="' . esc_attr( $this->field_name( '[all]' ) ) . '" value="' . esc_attr( $value['all'] ) . '"' . $placeholder . ' class="sp_wqv-input-number sp_wqv--is-unit" step="any" />';
				...
				foreach ( $properties as $property ) {
					...
					echo '<input type="number" name="' . esc_attr( $this->field_name( '[' . $property . ']' ) ) . '" value="' . esc_attr( $value[ $property ] ) . '"' . $placeholder . ' class="sp_wqv-input-number sp_wqv--is-unit" step="any" />';
					echo ( ! empty( $args['unit'] ) ) ? '<span class="sp_wqv--label sp_wqv--unit">' . esc_attr( $args['unit'] ) . '</span>' : '';
					echo '</div>';
			...
			if ( ! empty( $args['color'] ) ) {
				...
				echo '<input type="text" name="' . esc_attr( $this->field_name( '[color]' ) ) . '" value="' . esc_attr( $value['color'] ) . '" class="sp_wqv-color"' . $default_color_attr . ' />';
				echo '</div>';
				echo '</div>';
			}
			if ( ! empty( $args['hover_color'] ) ) {
				...
				echo '<div class="sp_wqv--color">';
				echo '<div class="sp_wqv-field-color">';
				echo '<input type="text" name="' . esc_attr( $this->field_name( '[hover_color]' ) ) . '" value="' . esc_attr( $value['hover_color'] ) . '" class="sp_wqv-color"' . $default_color_attr . ' />';
				echo '</div>';
				echo '</div>';
			}
