...
jQuery(document).ready(function(){
    ...
    jQuery('#mb-demo-setup-guid .mb-setup-menu').attr("checked","checked");

    jQuery('#mb-setup-menu').click(function(){
        jQuery('#mb-demo-setup-guid .mb-setup-menu').css("display","block");
        jQuery('#mb-demo-setup-guid .mb-setup-contact').css("display","none");
        jQuery('#mb-demo-setup-guid .mb-setup-widget').css("display","none");
        jQuery('#mb-demo-setup-guid .mb-setup-social-icon').css("display","none");
    });

    jQuery('#mb-setup-contact').click(function(){
        jQuery('#mb-demo-setup-guid .mb-setup-menu').css("display","none");
        jQuery('#mb-demo-setup-guid .mb-setup-contact').css("display","block");
        jQuery('#mb-demo-setup-guid .mb-setup-widget').css("display","none");
        jQuery('#mb-demo-setup-guid .mb-setup-social-icon').css("display","none");
    });

    jQuery('#mb-setup-widget').click(function(){
        jQuery('#mb-demo-setup-guid .mb-setup-menu').css("display","none");
        jQuery('#mb-demo-setup-guid .mb-setup-contact').css("display","none");
        jQuery('#mb-demo-setup-guid .mb-setup-widget').css("display","block");
        jQuery('#mb-demo-setup-guid .mb-setup-social-icon').css("display","none");
    });

    jQuery('#mb-setup-social').click(function(){
        jQuery('#mb-demo-setup-guid .mb-setup-menu').css("display","none");
        jQuery('#mb-demo-setup-guid .mb-setup-contact').css("display","none");
        jQuery('#mb-demo-setup-guid .mb-setup-widget').css("display","none");
        jQuery('#mb-demo-setup-guid .mb-setup-social-icon').css("display","block");
    });
});